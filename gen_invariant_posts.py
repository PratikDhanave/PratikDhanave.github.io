...
dict(
  ...
  <p>The Guardrails product is a managed version of this architecture, available without building the policy infrastructure from scratch. For teams not running on Go or not building on MARA, it's the fastest path to the same guarantee.</p>
