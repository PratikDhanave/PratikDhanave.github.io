...
*Deep-dive into building scalable, cost-aware multi-agent systems in production. Case study: Genie (15-agent financial assistant on the Microsoft Agent Framework).*
...
Over the past 18 months, I've architected and shipped **Genie** — a 15-agent financial assistant on the Microsoft Agent Framework. This article distills lessons from that journey and other production deployments.
