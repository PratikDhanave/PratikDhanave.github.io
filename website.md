...
| Blog count mismatch | Footer says "View All Articles (29+)" | You have 103+ articles — the 29 is only the new markdown-sourced posts, but a visitor doesn't know that |
...
- 103+ published articles — you're a prolific technical author, not just a coder
...
**Highlight cards are too few:** Only 4 cards (speaking, Tata, OSS, Bodh). Missing: GSoC 9-year mentoring, team leadership, international teams, 103+ articles.
...
- Blog as a form of technical communication (103+ published articles)
...
10. Fix blog article count (29+ → 103+)
...
**You've done Staff-level international work across 5 countries, mentored 40+ engineers for 9 years, saved $12M for one of India's largest conglomerates, and authored 103+ technical articles — but your site presents you as a senior engineer from Pune with one conference talk and some vague certifications.**
