...
PROJECT_META = {
  "slug": {
    ...
    "blog_tags": ["MARA", "Security", ...],  # for related posts
...
**Open Source (3):**
1. **Genie** - Multi-agent financial assistant on MARA
   - Status: active, featured
   - GitHub: c2siorg/genie

2. **Bodh** - Medical AI platform on MARA
   - Status: active
...
1. **Auto-related by `blog_tags`**
   ...
   - Projects set `blog_tags` list (e.g., Genie → ["MARA", "Multi-Agent AI", "Security"])
...
2. **Topic page links**
   ...
   - Currently: Genie → MARA tag page, Bodh → bodh topic page, HarbourBridge → spanner tag page
